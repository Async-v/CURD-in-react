...
const Read = (props) => {
    ...
    return (
        <div className="w-[40%] flex flex-col gap-5 h-full text-center text-white p-5">
            <h1 className="text-3xl font-bold tracking-widest border-1 p-4 uppercase"><span className="text-orange-200">Pending</span> Todos</h1>
            <ol className="w-full h-full flex flex-col gap-4 border-1 p-4 overflow-hidden">{rendertodos}</ol>
        </div>
    )
}
